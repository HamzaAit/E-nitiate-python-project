...
player = pygame.image.load("app_resources/image_resources/awesome.png")
...
while continuer:
    ...
    for event in pygame.event.get():
        ...
        if event.type == KEYDOWN:
            if event.key == K_ESCAPE:
                ...
                #player = pygame.image.load("C:/Users/64066/Downloads/Poop Mania (Copyright)/Poop Mania (copyright)/app_resources/image_resources/awesomegauche.png")
                movex = -4
    ...
    message = "Life: "+str(Vie)
    font = pygame.font.Font(None, 40)
    text = font.render(message, Vie, black)
    screen.blit(text, (1185,10))
