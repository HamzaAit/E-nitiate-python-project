...
image_resources = "C:/Users/64066/Desktop/Pygame_App/app_resources/image_resources/"
sound_resources = "C:/Users/64066/Desktop/Pygame App/app_resources/sound_resources/"
...
background = GetSource().background("20413-thewallpaper.jpg")
player = GetSource().player("ball_blue.png").convert_alpha()
...
while True:
    ...
    text = font.render(message, points, white)
